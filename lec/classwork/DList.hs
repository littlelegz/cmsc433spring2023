...
todo = error "You are meant to implement all todos"
...
list :: [Int]
list = 1 : 2 : 3 : [] -- end is the empty list `[]`

{-
The analogous "difference list" replaces the empty list at the end of the list
with a parameter.
-}
