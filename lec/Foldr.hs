...
apply function without acc, when hit base case apply acuumulator, function returns actual value not just a function
...
intersperse :: a -> [a] -> [a]
intersperse i l = foldr (\x n -> case (n) of 
  [] -> x : n
  _ -> x : i : n) [] l
